...
<section data-aos="fade-up" id="guru-info">
	...
	<div class="row justify-content-between align-items-center m-0">
		<div>
			<h1><?=$title ?></h1>
			<p>Berikut adalah course yang tersedia!</p>
		</div>
	</div>
	<div class="mb-5"></div>
			...
			<?php if (count($courses) < 1): ?>
				...
				<?php else : ?>
					<?php foreach ($courses as $course): ?>
						<a href="<?=base_url('course/detailCourse/').$course['uuid'] ?>" style="color: inherit; text-decoration: none">
										...
										<div class="col-lg-5">
											...
											<div class="col">
												...
												<p class="badge badge-primary m-0"><i class="fas fa-fw fa-users"></i>
													...
													<p class="badge badge-success">Mata Pelajaran : <?=$course['mapel'] ?></p>
													<?php
