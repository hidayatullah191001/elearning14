<div class="modal fade" id="deleteTopik<?=$topik['id_forum_topik']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
aria-hidden="true">
  ...
  <div style="border-radius: 30px" class="modal-content border-0">
    <div class="modal-body px-1 py-5 text-center">
      ...
      <div class="row m-0 d-flex justify-content-center mt-4">
       ...
       <a href="<?=base_url('forum/deleteTopik/').$topik['id_forum_topik'].'/'.$_GET['forum']?>"><button class="btn btn-delete">Delete</button></a>
     </div>
   </div>
 </div>
</div>
...
<script>
  $('#deleteTopik<?=$topik['id_forum_topik']?>').appendTo("body");
</script>
