    ...
    <div class="col-12 col-lg-9">
      <div class="tab-content" id="v-pills-tabContent">
        <div class="tab-pane fade show active" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
            <div class="card">
                <div class="card-body">
                    <h4 class="color-dark">Profile User</h4>
                    <form method="post" action="<?=base_url('guru/updateProfile') ?>" class="mt-5">
                        <input type="text" name="id_user" value="<?=$user['id'] ?>" hidden="">
                        <input type="text" name="id_guru" value="<?=$user['profile_id'] ?>" hidden="">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <label for="" style="font-weight: 500;">Biografi</label>
                            <textarea style="height: 80px" placeholder="Buat biografi..." name="bio" class="form-control"><?=$user['bio'] ?></textarea>
                        </div>

                        <div class="form-group">
                            <label for="" style="font-weight: 500;">Bidang Mata Pelajaran</label>
                            <select name="mapel_id" style="border-radius: 10px; height: 40px;" class="form-control">
                                <?php if ($user['mapel_id'] == 0): ?>
                                    <option selected disabled>Pilih mata pelajaran...</option>
                                <?php endif ?>
                                <?php foreach ($mapel as $mpl): ?>
                                    <?php if ($mpl['id_mapel'] == $user['mapel_id']): ?>
        ...
        <div class="tab-pane fade" id="v-pills-photo" role="tabpanel" aria-labelledby="v-pills-photo-tab">
            <div class="card">
                <div class="card-body">
                    <h4 class="color-dark">Photo Profile</h4>
                    <form class="mt-5" enctype="multipart/form-data" action="<?=base_url('guru/updatePhoto') ?>" method="post">
                        <input type="text" name="id_user" value="<?=$user['id'] ?>" hidden="">
                        <div class="form-group">
        ...
        <div class="tab-pane fade" id="v-pills-password" role="tabpanel" aria-labelledby="v-pills-password-tab">
            <div class="card">
                <div class="card-body">
                    <h4 class="color-dark">Ubah Password</h4>
                    <form method="post" action="<?=base_url('guru/ubahPassword') ?>" class="mt-5">
                        <div class="form-group">
