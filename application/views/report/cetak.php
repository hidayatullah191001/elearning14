...
<body>
	...
	<table id="table">
		...
		<h4>Riwayat Course Yang Diikutin</h4>
		<?php foreach ($enrollCourse as $ec): ?>
			
			<h6><b><?=$ec['nama_course']?></b></h6>
			<table id="table">
				<thead>
					<tr>
						<th>No</th>
			...
			<table id="table">
				...
				<tbody>
					...
					foreach ($sections as $section): ?>
						<?php if ($section['uuid_course'] == $ec['uuid']): ?>
							<tr style="text-align: center">
								<td><?=$i++ ?></td>
