<div class="modal fade" id="deleteUjian<?=$ujian['id_ujian']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
aria-hidden="true">
<div  class="modal-dialog modal-dialog-centered" role="document">
  <div style="border-radius: 30px" class="modal-content border-0">
    <div class="modal-body px-1 py-5 text-center">
      ...
      <h3 style="font-weight: 700">Delete <?=$ujian['title_ujian'] ?></h3>
      ...
      <div class="row m-0 d-flex justify-content-center mt-4">
       ...
       <a href="<?=base_url('ujian/deleteUjian/').$ujian['id_ujian'] ?>"><button class="btn btn-delete">Delete</button></a>
     </div>
   </div>
 </div>
</div>
...
<script>
  $('#deleteUjian<?=$ujian['id_ujian']?>').appendTo("body");
</script>
