          ...
          <div class="tab-content" id="v-pills-tabContent">
            <div class="tab-pane fade show active" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                <div class="card">
                    <div class="card-body">
                        <h4>Profile User</h4>
                        <form method="post" action="<?=base_url('siswa/updateProfile') ?>" class="mt-5">
                            <input type="text" name="id_user" value="<?=$user['id'] ?>" hidden="">
                            <input type="text" name="id_siswa" value="<?=$user['profile_id'] ?>" hidden="">
                            ...
                            <div class="form-group">
                                <label for="" style="font-weight: 500;">NISN</label>
                                <input type="text" style="border-radius: 10px; height: 40px;" class="form-control" name="nisn" value="<?=$siswa['nisn'] ?>" placeholder="Masukkan nisn..." required>
                            </div>

                            <div class="form-group">
                                <label for="" style="font-weight: 500;">Kelas</label>
                                <select name="kelas_id" style="border-radius: 10px; height: 40px;" class="form-control">
                                    <?php if ($siswa['kelas_id'] == 0): ?>
                                        <option selected disabled>Pilih mata pelajaran...</option>
                                    <?php endif ?>
                                    <?php foreach ($kelas as $kls): ?>
                                        <?php if ($kls['id_kelas'] == $user['kelas_id']): ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" style="border-radius: 10px; height: 40px;" class="form-control" name="no_telp" value="<?=$siswa['no_telp'] ?>" placeholder="Masukkan No Telepon..." required>
                                </div> 
                ...
                <div class="tab-pane fade" id="v-pills-photo" role="tabpanel" aria-labelledby="v-pills-photo-tab">
                    <div class="card">
                        <div class="card-body">
                            <h4>Photo Profile</h4>
                            <form class="mt-5" enctype="multipart/form-data" action="<?=base_url('siswa/updatePhoto') ?>" method="post">
                                <input type="text" name="id_user" value="<?=$user['id'] ?>" hidden="">
                                <div class="form-group">
                ...
                <div class="tab-pane fade" id="v-pills-password" role="tabpanel" aria-labelledby="v-pills-password-tab">
                    <div class="card">
                        <div class="card-body">
                            <h4>Ubah Password</h4>
                            <form method="post" action="<?=base_url('siswa/ubahPassword') ?>" class="mt-5">
                                <div class="form-group">
